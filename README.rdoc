...
Edit application_controller.rb method set_locale.
For russian
def set_locale
  I18n.locale = 'ru'
end
...
Copy config/locales/en.yml to config/locales/your_language.yml and translate.
When finished - set default locale for your crm.

=== For Developers

Fat Free CRM can be customized by trapping callback hooks and extended by adding
plugins. Please see http://github.com/michaeldv/crm_sample_plugin/tree/master and
http://github.com/michaeldv/crm_web_to_lead/tree/master for sample source code
